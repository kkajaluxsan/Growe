export const NAV_ITEMS = [
  ...
  { to: '/ai-assistant', label: 'Growe Assistant', roles: ['student', 'tutor', 'admin'] },
  { to: '/ai-flashcards', label: 'Growe Smart Flashcards', roles: ['student', 'tutor', 'admin'] },
...
const exactTitles = {
  ...
  '/messages': 'Messages',
  '/ai-assistant': 'Growe Assistant',
  '/ai-flashcards': 'Growe Smart Flashcards',
