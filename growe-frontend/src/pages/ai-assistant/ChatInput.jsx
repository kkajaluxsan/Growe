...
export default function ChatInput({ onSend, disabled, loading = false, placeholder = 'Message the assistant…' }) {
  ...
  return (
    <div className="border-t border-slate-200 bg-white/95 p-4 backdrop-blur dark:border-slate-700 dark:bg-slate-900/95">
      <div className="mx-auto flex max-w-4xl gap-3">
        ...
        />
        <Button type="button" onClick={submit} disabled={disabled || !value.trim()} loading={loading}>
          Send
        </Button>
      </div>
